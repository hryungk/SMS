...
public interface StudentDAO {
	 ...
	 * course if not attending already
	 *  
	 * It checks in the join table (i.e. Student_Course) generated by JPA to 
	 * find if a Student with that email is currently attending a Course with 
	 * that ID. If the Student is not attending that Course, register the 
